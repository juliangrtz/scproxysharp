...
namespace SupercellProxy.Crypto.Piranha
{
    internal class EnDecrypt
    {
        ...
        private static readonly KeyPair CustomKeyPair = new();
        ...
        public static byte[] EncryptPacket(Packet p)
        {
            ...
            else if (packetID == 10101)
            {
                ...
                Blake2b.Update(Keys.ServerPublicKey);
                ...
                encryptedPayload = CustomNaCl.CreatePublicBox(decryptedPayload, tmpNonce, CustomKeyPair.SecretKey, Keys.ServerPublicKey);
        ...
        public static byte[] DecryptPacket(Packet p)
        {
            ...
            else if (packetID == 20103 || packetID == 20104)
            {
                if (State >= Status.Authentification)
                {
                    ...
                    decryptedPayload = CustomNaCl.OpenPublicBox(encryptedPayload, tmpNonce, CustomKeyPair.SecretKey, Keys.ServerPublicKey);
