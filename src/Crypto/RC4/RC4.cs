...
namespace SupercellProxy.Crypto.RC4
{
    /// <summary>
    /// Rest in peace, (A)RC4.
    /// You are only relevant in Clash Royale's UDP protocol now :(
    /// </summary>
    internal class RC4
    {
        public const int KeyBoxLength = 256;
        public static byte[] Key => "fhsd6f86f67rt8fw78fw789we78r9789wer6re".ToByteArray(); // Old key...
