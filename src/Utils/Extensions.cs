...
internal static class Extensions
{
    ...
    {
        return (str.Length > maxLen) ? string.Concat(str.AsSpan(0, maxLen), "...") : str;
    }

    /// <summary>
    /// Returns a socket's IP
    /// </summary>
    public static string GetIP(this Socket s)
        => ((IPEndPoint)s.RemoteEndPoint).Address.ToString();

    /// <summary>
    /// Returns a readable version of a <see cref="SupercellGame"/>
    /// </summary>
    public static string ReadableName(this SupercellGame supercellGame)
    {
        return supercellGame switch
        {
            SupercellGame.BOOM_BEACH => "Boom Beach",
            SupercellGame.CLASH_OF_CLANS => "Clash of Clans",
            SupercellGame.CLASH_ROYALE => "Clash Royale",
            SupercellGame.BRAWL_STARS => "Brawl Stars",
            SupercellGame.HAY_DAY => "Hay Day",
            _ => string.Empty,
        };
    }
    ...
    public static object ReadField(this BinaryReader br, FieldType type)
    {
        ...
        switch (type)
        {
            ...
            case FieldType.BigEndianInt:
                field = br.ReadIntWithEndian();
                break;

            case FieldType.BigEndianInt64:
                field = br.ReadLongWithEndian();
                break;

            case FieldType.BigEndianShort:
            ...
            case FieldType.BigEndianUInt:
                field = br.ReadUIntWithEndian();
                break;

            case FieldType.BigEndianUInt64:
            ...
            case FieldType.BigEndianUShort:
